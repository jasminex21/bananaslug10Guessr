...
class Lyrics(): 
    ...
    def get_artist_name(self) -> str:
        """
        Method that returns the name of the (primary) artist of the track
        whose lyrics were returned. Obviously not necessary in the general
        lyriguessr game, but would be helpful for a game based on a playlist.

        Returns: 
            The correct artist name
        """
        return self.data["artist"][self.rand_num]
